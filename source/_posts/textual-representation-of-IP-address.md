...
我发现一个IPv4地址可能拥有上百个不同的表示形式，而由于一些历史原因，在这方面的标准尚未完全统一，因此这些形式在大部分情况下都是可被正常解析的(举个例子，这个URL http://000000300.0x000000000a8.00102.00000000351 会解析成http://192.168.66.233/ )，这就在绕过限制和其他一些安全问题上提供了想象的空间。为此我写了个小脚本，放在了GitHub上，地址在文章开头。
